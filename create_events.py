...
gcf_df = pd.read_csv(f'{inputs_path}/framewise_gcf_longlist.csv', index_col=0)
...
csf_df = pd.read_csv(f'{inputs_path}/total_energy_videos_updated.csv')
...
rms_df = pd.read_csv(f'{inputs_path}/framewise_rms_longlist.csv', index_col=0)
...
with open('./events_per_movie_longlist.pickle','wb') as f:
