...
with open('cod_results/new_longlist/t_stats/model_effiency_select_movies_desmat_blockpermovie_con_all_trial_type_random_weight_target_movies_8.csv','r') as f:
    ...
    plt.tight_layout()
    plt.savefig('./cod_results/new_longlist/t_stats/longlist_new_fstat_target_8_bar.jpg')
