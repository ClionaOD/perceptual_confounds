...
with open('cod_results/stats/longlist_across_movie_Fstats_target_8.csv','r') as f:
    ...
    plt.tight_layout()
    plt.savefig('./cod_results/pres_figs/longlist_across_movie_Fstats_target_8_bar.jpg')
